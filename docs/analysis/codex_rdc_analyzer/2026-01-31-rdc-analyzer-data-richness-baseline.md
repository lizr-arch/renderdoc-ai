# 2026-01-31 数据丰富度基线（对标 RenderDoc 源码）
...
证据入口（A/C 输出）
- A 路线 EventPassData（schema）：`docs/analysis/codex_rdc_analyzer/2026-01-20-rdc-analyzer-schema-single-analysis.md:129`
...
- C 路线 compare 输入结构：`docs/analysis/codex_rdc_analyzer/2026-01-20-rdc-analyzer-schema-compare.md:21`
...
- HOW（证据）：
  - Schema 说明：`docs/analysis/codex_rdc_analyzer/2026-01-20-rdc-analyzer-schema-single-analysis.md:129`
...
- HOW（证据）：`docs/analysis/codex_rdc_analyzer/2026-01-20-rdc-analyzer-schema-compare.md:21`
...
- HOW（证据）：`docs/analysis/codex_rdc_analyzer/2026-01-20-rdc-analyzer-schema-compare.md:43`
