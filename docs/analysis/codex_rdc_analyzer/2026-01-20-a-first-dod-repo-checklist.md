...
> 目标：把 `2026-01-20-abc-modes-market-and-a-first-loop.md` 里的 A-first DoD（7.1~7.8）  
...
- 先读 DoD 原文：`docs/analysis/codex_rdc_analyzer/2026-01-20-abc-modes-market-and-a-first-loop.md` 的 `## 7)`  
...
- `docs/analysis/codex_rdc_analyzer/2026-01-20-rdc-analyzer-schema-single-analysis.md`（文档契约）
