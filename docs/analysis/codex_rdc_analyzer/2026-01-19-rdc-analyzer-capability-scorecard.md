...
- 功能明细（WHAT/WHY/HOW）：`docs/analysis/codex_rdc_analyzer/2026-01-19-rdc-analyzer-feature-details.md`
- 深度下钻（WHAT/WHY/HOW）：`docs/analysis/codex_rdc_analyzer/2026-01-19-rdc-analyzer-key-deep-dive.md`
- 规则逐条（36 条 RD_*）：`docs/analysis/codex_rdc_analyzer/2026-01-20-rdc-analyzer-rules-*.md`
- Schema/对外契约：`docs/analysis/codex_rdc_analyzer/2026-01-20-rdc-analyzer-schema-*.md`
...
> - `D:/Code/git/renderdoc/docs/analysis/codex_rdc_analyzer/2026-01-19-rdc-analyzer-feature-details.md`

### 1.6 深度下钻（你选择的 3：优先把 5–10 个“最关键功能”讲透）

> 章节已拆分到单独文档（避免单文件 > 800 行）：
> - `D:/Code/git/renderdoc/docs/analysis/codex_rdc_analyzer/2026-01-19-rdc-analyzer-key-deep-dive.md`
