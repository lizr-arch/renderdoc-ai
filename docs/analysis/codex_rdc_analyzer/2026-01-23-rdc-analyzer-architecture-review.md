# RDC Analyzer 架构复审 & A-first 缺口清单（2026-01-23）
...
- WHAT: `scripts/rdc_analyzer` 共 **168** 个 Python 文件（统计日期：2026-01-23）。  
...
1) **默认验证（主路径）**  
   ...
   - 实测：**501 passed, 8 skipped**（2026-01-23）
2) **CLI 闭环（单帧 + 对比）**  
