...
重构说明：
- CSS 已提取到 assets/styles/simple_report.css
- JS 已提取到 assets/scripts/simple_report.js
"""
...
def _load_asset(subpath: str) -> str:
    """加载外部资源文件"""
    asset_path = _ASSETS_DIR / subpath
    try:
...
def generate_simple_html(textures: list, rdc_name: str, output_path: str,
    ...
    # 加载外部资源
    css_content = _load_asset("styles/simple_report.css")
    js_content = _load_asset("scripts/simple_report.js")
