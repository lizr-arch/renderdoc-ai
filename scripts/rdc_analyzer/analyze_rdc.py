...
VULKAN_EID_EVENT_CHUNK_IDS: set[int] = {
    ...
    int(VulkanChunk.vkCmdBlitImage2),
    int(VulkanChunk.vkCmdCopyBuffer),
    int(VulkanChunk.vkCmdCopyBuffer2),
    int(VulkanChunk.vkCmdCopyImage),
    int(VulkanChunk.vkCmdCopyImage2),
    int(VulkanChunk.vkCmdCopyBufferToImage),
    int(VulkanChunk.vkCmdCopyBufferToImage2),
    int(VulkanChunk.vkCmdCopyImageToBuffer),
    int(VulkanChunk.vkCmdCopyImageToBuffer2),
    int(VulkanChunk.vkCmdResolveImage),
    int(VulkanChunk.vkCmdResolveImage2),
